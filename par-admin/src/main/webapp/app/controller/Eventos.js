Ext.define('Paranimf.controller.Eventos', {
   ...
   stores: ['Eventos', 'EventosMultisesion', 'TiposEventosSinPaginar', 'Sesiones', 'PlantillasPreciosCombo', 'PreciosSesion', 'Salas', 'SalasEvento', 'Nacionalidades', 'Peliculas', 'Tpvs'],
